...
uses
  ...
  D2Bridge.Forms, ZDataset, uDM, uFormPrincipal;
...
type
  ...
  TFormCrudTemplate2 = class(TFormPrincipal)
...
function FormCrudTemplate2: TFormCrudTemplate2;
...
function FormCrudTemplate2: TFormCrudTemplate2;
begin
  result:= TFormCrudTemplate2(TFormCrudTemplate2.GetInstance);
end;

procedure TFormCrudTemplate2.StartCardData;
begin
  FStartCard:= FCrud_CardData;
end;

procedure TFormCrudTemplate2.CrudDefaultSearch(ATable: string;
...
function TFormCrudTemplate2.CrudOnBack: boolean;
begin
  result:= true;
end;

function TFormCrudTemplate2.CrudOnClose: boolean;
begin
  result:= true;
end;

procedure TFormCrudTemplate2.OnEditClick(Sender: TObject);
begin
  CrudOperation(OpEdit);
end;

procedure TFormCrudTemplate2.OnDeleteClick(Sender: TObject);
begin
  CrudOperation(OpDelete);
end;

function TFormCrudTemplate2.CrudOnDelete: boolean;
begin
  result:= true;

end;

function TFormCrudTemplate2.CrudOnEdit: boolean;
begin
  result:= true;

end;

function TFormCrudTemplate2.CrudOnInsert: boolean;
begin
  result:= true;

end;

procedure TFormCrudTemplate2.CrudOnOpen;
begin

end;

function TFormCrudTemplate2.CrudOnSave: boolean;
begin
  result:= true;

end;

procedure TFormCrudTemplate2.CrudOnSearch(AText: string);
begin

end;

procedure TFormCrudTemplate2.Crud_ButtonBackClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCrudTemplate2.FormDestroy(Sender: TObject);
begin
...
procedure TFormCrudTemplate2.Crud_ButtonDeleteClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCrudTemplate2.Crud_ButtonNewClick(Sender: TObject);
begin
  CrudOperation(OpInsert);
end;

procedure TFormCrudTemplate2.Crud_ButtonSaveClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCrudTemplate2.Crud_ButtonSearchClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCrudTemplate2.Crud_DoExportCardData;
begin
...
procedure TFormCrudTemplate2.StartCardSearch;
begin

end;

procedure TFormCrudTemplate2.Crud_DoExportCardSearch;
begin
...
procedure TFormCrudTemplate2.CrudOperation(ACrudOperation: CrudOperation);
begin
...
function TFormCrudTemplate2.CrudOperationPermission(ACrudOperation: CrudOperation
  ): boolean;
begin
  result:= true;
...
procedure TFormCrudTemplate2.EndRender;
begin
  inherited;
...
procedure TFormCrudTemplate2.ExportD2Bridge;
begin
  inherited;
...
procedure TFormCrudTemplate2.FormCreate(Sender: TObject);
begin
...
procedure TFormCrudTemplate2.FormShow(Sender: TObject);
begin
  inherited;
...
function TFormCrudTemplate2.GetColSize: string;
begin
  Result:= FColSize;
end;

function TFormCrudTemplate2.GetCrudPermissions: TCrudPermissions;
begin
  result:= FCrudPermissions;
end;

procedure TFormCrudTemplate2.InitControlsD2Bridge(
...
procedure TFormCrudTemplate2.RenderD2Bridge(const PrismControl: TPrismControl;
...
procedure TFormCrudTemplate2.BeginRender;
begin
  inherited BeginRender;
end;

procedure TFormCrudTemplate2.SetColSize(AValue: string);
begin
  FColSize:= AValue;
...
procedure TFormCrudTemplate2.SetCrudPermissions(APermissions: TCrudPermissions);
begin
  //Fix PermTotal
