...
uses
  ...
  ZDataset, uDM, uFormPrincipal, D2Bridge.Forms;
...
type
  ...
  TFormCrudTemplate3 = class(TFormPrincipal)
...
function FormCrudTemplate3: TFormCrudTemplate3;
...
function FormCrudTemplate3: TFormCrudTemplate3;
begin
  result:= TFormCrudTemplate3(TFormCrudTemplate3.GetInstance);
end;

procedure TFormCrudTemplate3.StartCardData;
begin
  FStartCard:= FCrud_CardData;
end;

procedure TFormCrudTemplate3.CrudDefaultSearch(ATable: string;
...
function TFormCrudTemplate3.CrudOnBack: boolean;
begin
  result:= true;
end;

function TFormCrudTemplate3.CrudOnClose: boolean;
begin
  result:= true;
end;

procedure TFormCrudTemplate3.OnEditClick(Sender: TObject);
begin
  CrudOperation(OpEdit);
end;

procedure TFormCrudTemplate3.OnDeleteClick(Sender: TObject);
begin
  CrudOperation(OpDelete);
end;

function TFormCrudTemplate3.CrudOnDelete: boolean;
begin
  result:= true;
end;

function TFormCrudTemplate3.CrudOnEdit: boolean;
begin
  result:= true;
end;

function TFormCrudTemplate3.CrudOnInsert: boolean;
begin
  result:= true;
end;

procedure TFormCrudTemplate3.CrudOnOpen;
begin

end;

function TFormCrudTemplate3.CrudOnSave: boolean;
begin
  result:= true;
end;

procedure TFormCrudTemplate3.CrudOnSearch(AText: string);
begin

end;

procedure TFormCrudTemplate3.Crud_ButtonBackClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCrudTemplate3.FormDestroy(Sender: TObject);
begin
...
procedure TFormCrudTemplate3.Crud_ButtonDeleteClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCrudTemplate3.Crud_ButtonNewClick(Sender: TObject);
begin
  CrudOperation(OpInsert);
end;

procedure TFormCrudTemplate3.Crud_ButtonSaveClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCrudTemplate3.Crud_ButtonSearchClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCrudTemplate3.Crud_DoExportCardData;
begin
...
procedure TFormCrudTemplate3.StartCardSearch;
begin

end;

procedure TFormCrudTemplate3.Crud_DoExportCardSearch;
begin
...
procedure TFormCrudTemplate3.CrudOperation(ACrudOperation: CrudOperation);
begin
...
function TFormCrudTemplate3.CrudOperationPermission(ACrudOperation: CrudOperation
  ): boolean;
begin
  result:= true;
...
procedure TFormCrudTemplate3.EndRender;
begin
  inherited;
...
procedure TFormCrudTemplate3.ExportD2Bridge;
begin
  inherited;
...
procedure TFormCrudTemplate3.FormCreate(Sender: TObject);
begin
...
procedure TFormCrudTemplate3.FormShow(Sender: TObject);
begin
...
function TFormCrudTemplate3.GetColSize: string;
begin
  Result:= FColSize;
end;

function TFormCrudTemplate3.GetCrudPermissions: TCrudPermissions;
begin
  result:= FCrudPermissions;
end;

procedure TFormCrudTemplate3.InitControlsD2Bridge(
...
procedure TFormCrudTemplate3.RenderD2Bridge(const PrismControl: TPrismControl;
...
procedure TFormCrudTemplate3.BeginRender;
begin
  inherited BeginRender;
end;

procedure TFormCrudTemplate3.SetColSize(AValue: string);
begin
  FColSize:= AValue;
...
procedure TFormCrudTemplate3.SetCrudPermissions(APermissions: TCrudPermissions);
begin
  //Fix PermTotal
